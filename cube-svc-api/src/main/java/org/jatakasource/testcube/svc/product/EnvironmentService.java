...
public interface EnvironmentService extends CRUDService<IEnvironment, Long> {

	List<IEnvironment> getAll(Paging paging, Sorting sorting, String keyword, Long productId);
}
