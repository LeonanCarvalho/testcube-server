...
public interface EnvironmentDao extends BaseDao<IEnvironment, Long> {
	List<IEnvironment> findAll(Paging paging, Sorting sorting, String keyword, Long productId);
}
