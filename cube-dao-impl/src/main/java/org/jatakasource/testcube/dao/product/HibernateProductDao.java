...
@Repository
public class HibernateProductDao extends BaseHibernateDao<IProduct, Long> implements ProductDao {
	...
	public List<IProduct> findAll(Paging paging, Sorting sorting, String keyword) {
