...
@Repository
public class HibernatePlanType extends BaseHibernateDao<IPlanType, Long> implements PlanTypeDao {

	public HibernatePlanType() {
		super(PlanType.class);
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<IPlanType> findAll(Paging paging, Sorting sorting, String keyword) {
		Criteria criteria = getCurrentSession().createCriteria(PlanType.class);
