...
@Repository
public class HibernateCaseStatus extends BaseHibernateDao<ICaseStatus, Long> implements CaseStatusDao {

	public HibernateCaseStatus() {
		super(CaseStatus.class);
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<ICaseStatus> findAll(Paging paging, Sorting sorting, String keyword) {
		Criteria criteria = getCurrentSession().createCriteria(CaseStatus.class);
