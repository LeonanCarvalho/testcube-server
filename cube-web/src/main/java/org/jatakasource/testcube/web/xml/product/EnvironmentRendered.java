...
public class EnvironmentRendered extends NameDescriptionRendered<IEnvironment> {

	public EnvironmentRendered() {
		super(new Environment());
	}

	public EnvironmentRendered(IEnvironment delegated) {
		super(delegated);
	}
